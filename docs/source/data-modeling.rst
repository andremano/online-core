...
.. important:: 
   **Resources**
   You will require the latest LTR version of LTR version of `QGIS <https://qgis.org/en/site/forusers/download.html>`_, plus the dataset  `data_modeling.zip <data_modeling_>`_.  When you unzip the dataset, you will find the following files inside:
